...
class WelcomeCreateProfile extends StatefulWidget {
  ...
  const WelcomeCreateProfile({super.key, required this.onBackPressed});
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            width: double.infinity,
            padding: const EdgeInsets.only(top: 10, left: 20, right: 50, bottom: 10),
            height: 45,
                      ...
                      children: _genres.map((genre) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected ? const Color(0xFFDC0404) : const Color(0xFF1E1E1E),
                              borderRadius: BorderRadius.circular(24),
                              border: Border.all(
                                color: isSelected ? const Color(0xFFDC0404) : const Color(0xFF2A2A2A),
                                width: 1,
                              ),
                            ),
                            child: Text(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children:[
                    ...
                    SizedBox(height: 14),
                    Text('Your personalized playlists will appear here',
                      style: GoogleFonts.inter(
                        color: Colors.white,
                        fontSize: 14,
                        fontWeight: FontWeight.w300,
